        ...
        <div class="row featured__filter">
            <div class="row" class="" style="margin-bottom:20%">
                ...
                <div class="col-md-12  bg-white  mt-2 mb-2 text-right" style="">
                    <div class="row">
                        <div class="col-md-6 mt-2" style="width: 50%;float:left">
                            <p class="m-0" style="font-size:14px"><a href="" class="text-dark"><strong>{{$car->car_name}}</strong></a></p>
                            <p class="m-0" style="font-size:13px"><strong>{{$car->modal}}</strong></p>
                            <p class="m-0" style="font-size:13px"><strong>{{$car->price}}</strong></p>
                            <p ><a href="#" class="m-0 " style="color:#0aab96;font-size: 18px"><i title="مقارنة" class="fa fa fa-retweet"></i></a></p>
                        </div>
                        <div class="col-md-6 mt-4 mb-2" style="width: 50%;float:left">
                            <a href=""> <img src="{{$car->outImages[0]->out}}" alt="img-fluid" style="border-radius:5%"></a>
